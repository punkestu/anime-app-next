...
export default function Navbar() {
  ...
  useEffect(() => {
    ...
    setIsAuth(Cookies.get("x-is-auth") === "true");
  }, []);
      ...
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className="hidden w-full md:block md:w-auto" id="navbar-default">
          <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 dark:bg-gray-900 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:md:bg-gray-900">
            ...
            <li className="flex items-center justify-center md:gap-2">
              {isAuth && (
                <Link
                  href="/profile"
                  className="block py-2 px-3 text-gray-900 dark:text-slate-400 rounded-sm md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0"
                >
                  <svg
